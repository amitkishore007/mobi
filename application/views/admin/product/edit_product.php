                                    ...
                                    <div class="portlet light bordered">
                                        <div class="portlet-title">
                                            ...
                                            <div class="actions btn-set">
                                                <a type="button" href='<?php echo base_url('product'); ?>' name="back" class="btn btn-transparent dark btn-outline  btn-sm">
                                                    <i class="fa fa-angle-left"></i> Back to products</a>
                                                <a class="btn btn-success" href='<?php echo base_url('product/create'); ?>'>
                                                    <i class="fa fa-share"></i> Add a new product</a>
                                                    ...
                                                    <div class="tab-pane active" id="tab_general">
                                                        <div class="form-body">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-md-3">
                                                                    <input type="text" name="demo2" value='' class="form-control product_vat"> 
                                                               <span class="error price-error text-danger"></span> 
                                                                </div>

                                                                <label class="col-md-2 control-label">CST:
                                                                    <span class="required"> * </span>
                                                                </label>
                                                                <div class="col-md-3">
                                                                    <input type="text"  name="demo2" value='' class="form-control product_cst"> 
                                                               <span class="error cst-error text-danger"></span> 
                                                                </div>
                                                            </div>
                                                            <!-- tax div end -->
                                                             <div class="form-group">
