	...
	<div id="customer_details" class="col2-set">
		<div class="col-1">
			...
			<!-- 	<p id="billing_company_field" class="form-row form-row form-row-wide"><label class="" for="billing_company">Company Name</label>
				...
				<input type="text" value="" placeholder="" id="billing_country" name="country" class="input-text ">
				...
				<input type="text" value="" placeholder="" id="billing_state" name="state" class="input-text ">
				...
				<input type="text" value="" placeholder="" id="billing_postcode" name="pincode" class="input-text ">
